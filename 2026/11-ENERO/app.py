...
st.set_page_config(page_title="Día 11 - Analizador de Sentimientos", layout="wide")

st.title("🧠 Día 11 — Analizador de Sentimientos (Modelo Entrenado con Dataset Ampliado)")
st.write("Clasificación de sentimiento usando un modelo entrenado con más de 400 frases.")
...
if st.button("🔍 Analizar sentimiento", type="primary"):
    if not texto_usuario.strip():
        ...
        proba = modelo.predict_proba([texto_usuario])[0]
        ...
        st.info("Modelo entrenado con dataset ampliado (positivo, negativo, neutro, sarcasmo, ambiguo).")
