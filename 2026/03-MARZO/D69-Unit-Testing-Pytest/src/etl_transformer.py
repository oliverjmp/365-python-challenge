...
# Bloque para ejecución directa desde terminal (Prueba rápida)
if __name__ == "__main__":
    datos_prueba = [
        {"id": 1, "value": 10.0, "category": " ventas "},
        {"id": 2, "value": 20.5, "category": "marketing"}
    ]
    
    transformer = ETLTransformer(multiplier=1.2)
    df_resultado = transformer.clean_and_transform(datos_prueba)
